...
//extern QWidget *setup;
CalcEdit::CalcEdit( QWidget *parent )
...
void CalcEdit::mouseReleaseEvent(QMouseEvent*)
{
    if(isReadOnly())
        return;
    QPoint	point;
    ...
    QString str = text();
    Calculator calc(str, CALCULATOR, this);
    // 적당한 키보드의 위치를 얻어낸다
...
// x=250,y=260
QPoint CalcEdit::getPtKeyboard(Calculator* calc)
{
